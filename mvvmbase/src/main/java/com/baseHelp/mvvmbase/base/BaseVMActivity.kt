package com.baseHelp.mvvmbase.base
...
import com.baseHelp.mvvmbase.R
import com.baseHelp.mvvmbase.view.LoadingDialog
...
abstract class BaseVMActivity<V : ViewDataBinding, VM : BaseViewModel>() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 这个是 new 的出来的。因为我们 使用了。koin 注入viewModal。所以不需要。
        viewModel = getVM()
